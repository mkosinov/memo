...
def _create_client(test_client: TestClient) -> str:
    ...
    resp = test_client.post("/api/v1/clients", json=CLIENT_PAYLOAD)
...
class TestVisitorsCrud:
    ...
    def test_create_visitor(self) -> None:
        ...
        with TestClient(app) as client:
            ...
            response = client.post("/api/v1/visitors", json=visitor_payload)
    ...
    def test_list_visitors_for_client(self) -> None:
        ...
        with TestClient(app) as client:
            ...
            client.post("/api/v1/visitors", json=visitor1)
            client.post("/api/v1/visitors", json=visitor2)
    ...
    def test_get_visitor_by_id(self) -> None:
        ...
        with TestClient(app) as client:
            ...
            create_resp = client.post("/api/v1/visitors", json=visitor_payload)
            visitor_id = create_resp.json()["id"]

            response = client.get(f"/api/v1/visitors/{visitor_id}")
            assert response.status_code == 200
            body = response.json()
    ...
    def test_update_visitor(self) -> None:
        ...
        with TestClient(app) as client:
            ...
            response = client.put(f"/api/v1/visitors/{visitor_id}", json=update_data)
            assert response.status_code == 200
            body = response.json()
    ...
    def test_delete_visitor_soft_deletes(self) -> None:
        ...
        with TestClient(app) as client:
            ...
            # Delete
            response = client.delete(f"/api/v1/visitors/{visitor_id}")
    ...
    def test_get_nonexistent_visitor_returns_404(self) -> None:
        ...
        app = create_app()
        with TestClient(app) as client:
            response = client.get("/api/v1/visitors/nonexistent-id")
    ...
    def test_delete_nonexistent_visitor_returns_404(self) -> None:
        ...
        app = create_app()
        with TestClient(app) as client:
            response = client.delete("/api/v1/visitors/nonexistent-id")
        assert response.status_code == 404
