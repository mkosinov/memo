...
async def test_seed_populates_masters(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_locations(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_services(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_tariffs(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_tags(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_activities(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_clients(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_visitors(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_records(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_visits(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_populates_payments(db_manager: DatabaseSessionManager) -> None:
...
async def test_seed_is_idempotent(db_manager: DatabaseSessionManager) -> None:
