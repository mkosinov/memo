...
**Спека:** `docs/specs/2026-09-16-deferred-record-deletion-design.md` (rev8 — единый контракт отложенного удаления: ветвь `stale_dependencies` получает честную ошибку с действием «Обновить», auto-зависимости исключены из сверки, subset-семантика; визиты/оплаты — соседние follow-up #297/#298, НЕ в скоупе этого плана).
