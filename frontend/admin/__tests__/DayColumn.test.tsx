...
// GH #141 Task 9: DayColumn itself is props-driven (no schedule context), so this
// file has NO new-context mocks to switch to. This registration stays ONLY because
// the real ActivityCard child still reads the old useSchedule() — ActivityCard
