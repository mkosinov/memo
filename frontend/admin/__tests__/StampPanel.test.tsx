...
vi.mock('@memo/api-client', () => {
  ...
  getAllLocations: vi.fn().mockResolvedValue([
    ...
    { id: 'grand', title: 'Гранд Отель Поляна', address: 'Гранд Отель, лобби', description: null, capacity: 10, yandex_map_url: null, review_url: null, record_info: null, image_url: null, archived: false, created_at: '', updated_at: '' },
    { id: 'p1389', title: 'Поляна 1389', address: 'Поляна 1389, 2 этаж', description: null, capacity: 10, yandex_map_url: null, review_url: null, record_info: null, image_url: null, archived: false, created_at: '', updated_at: '' },
  ]),
