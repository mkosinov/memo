...
import { POSITION_FIELDS, type PositionFieldConfig } from './positionFields';
...
/* ── Local inline field renderer (TagModal precedent) ─────────────── */

interface FieldRendererProps {
  field: PositionFieldConfig;
  value: unknown;
